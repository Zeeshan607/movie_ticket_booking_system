                    ...
                    <div class="row mx-0 mt-2">
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <select name="cinema_id" id="" class="custom-control custom-select bg-card-body text-light border-top-0  border-left-0 border-right-0  border-dark">
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <select name="play_slot" id="" class="custom-control custom-select bg-card-body text-light border-top-0  border-left-0 border-right-0  border-dark">
                                    <option value="null" selected disabled >--select---</option>
                                </select>
                            </div>
                        </div>
