    ...
    <div class="main-panel">
        ...
        <div class="content">
            <div class="container-fluid">
                ...
                <div class="row mx-0">
                    <div class="col-12">
                        <form action="./functions/update-movie.php?id=<?php echo $row["id"] ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="genre" id="genre" value="<?php echo $row["genre"] ?>" class="form-control">
                            </div>
                            <div class="form-group my-5">
                                <label for="">IMDB Ratings</label>
                                <input type="text" name="imdb_ratings" id="ratings" value="<?php echo $row["imdb_ratings"] ?>" class="form-control" autocomplete="off">
                            </div>

                            <div class="form-group  my-5" id="release_date">
                                <label for="">Release date</label>
                                <input type="date" name="release_date" value="<?php echo date("Y-m-d", strtotime($row['release_date'])) ?>" class="form-control" id="release_date">
                            </div>

                            <div class="form-check">
                                <label class="form-check-label">
                                    <input type="checkbox" class="form-check-input" <?php echo $row["is_upcoming"]? 'checked':"" ?> name="is_upcoming" id="isUpcoming" />
